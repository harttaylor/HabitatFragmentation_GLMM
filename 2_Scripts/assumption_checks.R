...
hyp1_500 <- read.csv("0_data/2_combined/500habitat_metrics_hyp1.csv")
hyp3_500 <- read.csv("0_data/2_combined/500habitat_metrics_hyp3.csv")

hyp1_150 <- read.csv("0_data/2_combined/landscape_metrics/150landscape_metrics_hyp1.csv")
hyp3_150 <- read.csv("0_data/2_combined/landscape_metrics/150landscape_metrics_hyp3.csv")

hyp1_1000 <- read.csv("0_data/2_combined/landscape_metrics/1000landscape_metrics_hyp1.csv")
hyp3_1000 <- read.csv("0_data/2_combined/landscape_metrics/1000landscape_metrics_hyp3.csv")
...
hyp1_cors <- analyze_correlations(hyp1_500)
hyp3_cors <- analyze_correlations(hyp3_500)
